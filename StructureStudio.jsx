...
// moment they continue. Rendered by StructureStudioInner via an early return (not an overlay)
// when !gatePassed && !isAdmin, so the designer stays out of the DOM until the gate is passed.
