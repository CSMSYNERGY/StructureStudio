            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
              ...
              {C.contactFields.includes("state") && (
                <div style={{ flex: "1 1 160px" }}>
                  ...
                  <select value={contact.state} onChange={(e) => setContact((p) => ({ ...p, state: e.target.value }))} style={{ ...S.sel, width: "100%", boxSizing: "border-box", color: contact.state ? undefined : "#94A3B8" }}>
